...
const siteConfig: SiteConfig = {
  ...
  fitItems: [
    ...
    {
      iconName: "FileText",
      jobReq: "Build and maintain commercial legal infrastructure: templates, playbooks, and process improvements",
      myFit: "Designed Drata's GTM-Legal playbooks, customer and vendor contract templates at Mimecast and Prometric, and AI-powered legal ops workflows from intake through closed-won. Operationalizing Legal so commercial teams can scale.",
      tags: ["Playbooks", "Templates", "Legal Ops", "AI Workflows"],
    },
    {
      iconName: "Brain",
      jobReq: "Curiosity about AI and commitment to responsible AI development",
      myFit: "Drata Legal's resident AI architect, building Drata's AI compliance program and deploying AI tools across the legal function. Negotiates AI terms in every commercial deal and translates AI policy into practical contract language.",
      tags: ["AI Compliance", "AI Policy", "Privacy", "Responsible AI"],
    },
  ],
