...
const siteConfig: SiteConfig = {
  ...
  experiences: [
    ...
    },
    {
      ...
      highlights: [
        ...
        "Managed review and negotiation of $14M+ in annual SaaS, vendor, and procurement contracts on behalf of Legal as Legal's representative on the Procurement Committee.",
      ],
    },
    {
      id: "mimecast",
  ...
  fitItems: [
    ...
    },
    {
      ...
      myFit: "Contracts is my anchor, but my career spans IP, procurement ($14M+ annual SaaS and vendor contracts at Snappy on the Procurement Committee), marketing review, employment, and policy work going back to UFT, NLRB, and EEOC. Low-ego doer who picks up what the team needs.",
